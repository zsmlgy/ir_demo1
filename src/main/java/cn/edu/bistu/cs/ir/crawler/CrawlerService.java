...
import cn.edu.bistu.cs.ir.index.NewsLucenePipeline;
...
public class CrawlerService{
     ...
     * @param limit
     */
    public void crawlTencentTechNews(int limit) {
        TencentTechNewsCrawler processor = new TencentTechNewsCrawler(limit);

        List<String> seedUrls = List.of(
                "https://news.qq.com/ch/tech",
                "https://news.qq.com/rain/a/20260402A031MO00",
                "https://news.qq.com/rain/a/20260401A04E8T00",
                "https://news.qq.com/rain/a/20260330A0603O00",
                "https://news.qq.com/rain/a/20260327A048AI00?adChannelId=tech",
                "https://news.qq.com/rain/a/20260311A05BR600",
                "https://news.qq.com/rain/a/20260306A04V6K00",
                "https://view.inews.qq.com/a/20260316A055RR00",
                "https://view.inews.qq.com/a/20260310A056ER00",
                "https://view.inews.qq.com/a/20260308A031DX00"
        );

        Spider.create(processor)
                .addUrl(seedUrls.toArray(new String[0]))
                .addPipeline(new NewsLucenePipeline(idxService))
                .thread(4)
                .run();
    }
